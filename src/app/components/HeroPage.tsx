    ...
    <main className={archivo.className}>
      <div className='bg-black h-[100vh] text-white grid grid-cols-2 p-16 '>
        <div className='textAreahere   '>
          <span className='text-8xl text-blue-500 font-bold '>
            Lightning-Fast Trades, Minimal Fees
          </span>{" "}
          <br />
          <span className='text-xl text-white/45 italic'>
            Experience the next generation of decentralized trading on{" "}
            <span className='text-blue-500'>ANKDCEX</span>. We offer seamless,
            secure, and cost-effective cryptocurrency exchanges.
          </span>
          <div className='pt-4'>
            Powered By
