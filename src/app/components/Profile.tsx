...
const Profile = ({ publicKey }: { publicKey: string }) => {
  ...
  return (
    <div className=''>
      {breakpoint ? (
        <div className='text-white flex justify-center text-center items-center align-middle text-5xl'>
          NOT SUPPORTED IN PHONE BROWSER, OPEN IN PC
        </div>
      ) : (
        <div
...
function Assets({
  ...
  return (
    <div className=''>
      ...
      <div className='bg-gray-300 p-5  mt-5 rounded-lg shadow-black/45 shadow-lg'>
